...
{
    return isInitialized() ? obj->as<QPDF_Array>() : nullptr;
}

QPDF_Bool*
QPDFObjectHandle::asBool() const
{
    return isInitialized() ? obj->as<QPDF_Bool>() : nullptr;
}

QPDF_Dictionary*
QPDFObjectHandle::asDictionary() const
{
    return isInitialized() ? obj->as<QPDF_Dictionary>() : nullptr;
}

QPDF_InlineImage*
QPDFObjectHandle::asInlineImage() const
{
    return isInitialized() ? obj->as<QPDF_InlineImage>() : nullptr;
}

QPDF_Integer*
QPDFObjectHandle::asInteger() const
{
    return isInitialized() ? obj->as<QPDF_Integer>() : nullptr;
}

QPDF_Name*
QPDFObjectHandle::asName() const
{
    return isInitialized() ? obj->as<QPDF_Name>() : nullptr;
}

QPDF_Null*
QPDFObjectHandle::asNull() const
{
    return isInitialized() ? obj->as<QPDF_Null>() : nullptr;
}

QPDF_Operator*
QPDFObjectHandle::asOperator() const
{
    return isInitialized() ? obj->as<QPDF_Operator>() : nullptr;
}

QPDF_Real*
QPDFObjectHandle::asReal() const
{
    return isInitialized() ? obj->as<QPDF_Real>() : nullptr;
}

QPDF_Reserved*
QPDFObjectHandle::asReserved() const
{
    return isInitialized() ? obj->as<QPDF_Reserved>() : nullptr;
}

QPDF_Stream*
QPDFObjectHandle::asStream() const
{
    return isInitialized() ? obj->as<QPDF_Stream>() : nullptr;
}
...
{
    return isInitialized() ? obj->as<QPDF_String>() : nullptr;
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_destroyed);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_boolean);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_null);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_integer);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_real);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_name);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_string);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_operator);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_inlineimage);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_array);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_dictionary);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_stream);
}
...
#endif
{
    return isInitialized() && (obj->getResolvedTypeCode() == ::ot_reserved);
}
...
#endif
{
    return isInitialized() && obj->hasDescription();
}
...
#endif
{
    QPDF* context = nullptr;
    std::string description;
    if (isInitialized() && obj->getDescription(context, description)) {
