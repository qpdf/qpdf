...
this->ap.addBare("deduplicate-image-xobjects", [this](){c_main->deduplicateImageXobjects();});
...
this->ap.addBare("global", b(&ArgParser::argGlobal));
...
this->ap.addRequiredParameter("filename", [this](std::string const& x){c_att->filename(x);}, "displayed-filename");
