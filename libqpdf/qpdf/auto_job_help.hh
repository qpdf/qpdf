...
ap.addOptionHelp("--deduplicate-image-xobjects", "transformation", "merge identical image XObject streams into a single object", R"(If the input file contains distinct but equivalent image XObject
