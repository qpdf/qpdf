...
// ABI: Replace QUtil.hh and QUtil.cc with QUtil_12.
// Replace libtests/qutil.cc with qutil_12.cc.
// Delete QUtil_12.hh, QUtil_12.cc, qutil_12.cc, main_from_wmain_12.cc and
// qutil_12.test.
// Update CMakeLists.txt files.
// Rename namespace QUtil_12 to QUtil.
// Globally replace #include<qpdf/QUtil_12.hh>.
// with #include <qpdf/QUtil.hh>.
// Globally replace QUtil_12:: with QUtil::.
// Uncomment all "QPDF_DLL"s in this file.
...
namespace QUtil_12
{
    ...
    //
    // QUtil_12::FileCloser fc(QUtil_12::safe_fopen(filename, "rb"));
    //
...
inline bool
QUtil_12::is_hex_digit(char ch)
{
    return (ch && (strchr("0123456789abcdefABCDEF", ch) != nullptr));
}

inline bool
QUtil_12::is_space(char ch)
{
    return (ch && (strchr(" \f\n\r\t\v", ch) != nullptr));
}

inline bool
QUtil_12::is_digit(char ch)
{
    return ((ch >= '0') && (ch <= '9'));
}

inline bool
QUtil_12::is_number(char const* p)
{
    // ^[\+\-]?(\.\d*|\d+(\.\d*)?)$
    if (!*p) {
        return false;
...
inline std::string
QUtil_12::hex_encode_char(char c)
{
